<template>
	<div class="dropp-booking">
		<div class="dropp-locations">
			...
			<div class="dropp-booking__empty" v-show="!locations.length && shipping_items.length">
				<div class="dropp-booking__empty-icon">
				...
				<h3 class="dropp-booking__empty-title">{{ i18n.no_booking_title || 'No active booking' }}</h3>
				<p class="dropp-booking__empty-text">{{ i18n.no_booking_subtitle || 'Start by filling out the booking form to create a new consignment.' }}</p>
			</div>
